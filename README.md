...
- 📦 Gestion des livraisons d’organes  
- 📡 Suivi en temps réel des drones  
- 🗺 Calcul intelligent des trajets  
- 🏥 Attribution automatique des zones (Voronoï)  
...
- Serveur / API  
- Base de données  
- Module algorithmique (Delaunay & Voronoï)  
...
## 🌍 Impact attendu
- Réduction du temps de livraison des organes  
- Optimisation logistique  
- Amélioration des chances de survie des patients  
